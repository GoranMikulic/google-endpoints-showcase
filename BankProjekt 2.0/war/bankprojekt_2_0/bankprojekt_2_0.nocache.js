...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "bankprojekt_2_0" because\n';
  ...
  $wnd.__gwt_activeModules['bankprojekt_2_0'] = {
    'moduleName' : 'bankprojekt_2_0',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/bankprojekt_2_0.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['bankprojekt_2_0'].superdevmode = true;

  var expectedSuffix = '/bankprojekt_2_0.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + bankprojekt_2_0 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:bankprojekt_2_0';
  var devModeSessionKey = '__gwtDevModeSession:bankprojekt_2_0';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/bankprojekt_2_0/bankprojekt_2_0.nocache.js';
  ...
  $wnd.__gwt_activeModules['bankprojekt_2_0'].canRedirect = true;
  $wnd.__gwt_activeModules['bankprojekt_2_0'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING bankprojekt_2_0';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/bankprojekt_2_0?user.agent=' + ua + '&_callback=' + callback;
