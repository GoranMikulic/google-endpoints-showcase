...
public class BankAdministrationImpl extends RemoteServiceServlet implements
		BankAdministration {
	...
	public void delete(Customer c) throws IllegalArgumentException {
		 ...
		 * in der Klasse BankVerwaltungImpl, durchführen. Grund: In der Klasse
		 * BankVerwaltungImpl ist die Verflechtung sämtlicher Klassen bzw. ihrer
		 * Objekte bekannt. Nur hier kann sinnvoll ein umfassender
	...
	/**
	 * Löschen des übergebenen Kontos. Beachten Sie bitte auch die Anmerkungen
	 * zu {@link #delete(Customer)}. Beim Löschen des Kontos werden sämtliche
	 * damit in Verbindung stehenden Buchungen gelöscht.
	 * 
	 * @see #delete(Customer)
	 */
	@Override
	...
	/**
	 * Anlegen eines neuen Kontos für den übergebenen Kunden. Dies führt
	 * implizit zu einem Speichern des neuen, leeren Kontos in der Datenbank.
	 * <p>
	 * 
	 ...
	 * 
	 * @param k
	 *            das Konto, dessen Stand wir berechnen möchten
	 */
	@Override
	 ...
	 * 
	 * @param k
	 *            das Konto, dessen Soll-Buchungen wir bekommen wollen.
	...
	public ArrayList<Transaction> getDebitsOf(Account k)
		...
		if (k != null && this.tMapper != null) {
			Vector<Transaction> transactions = this.tMapper
					.findBySourceAccount(k.getId());
	 ...
	 * 
	 * @param k
	 *            das Konto, dessen Haben-Buchungen wir bekommen wollen.
	...
	private Account getCashAccount() {
		...
		/*
		 * wenn das Kassenkonto nicht gefunden wird, erzeugen wir es mit der
		 * entsprechenden Kontonummer und dem Wert 0 als ownerID.
		 */
		if (account == null) {
			account = new Account();
	 ...
	 *            das Kundenkonto, von dem die Barabhebung erfolgen soll.
	 * @param amount
	...
	/**
	 * Hier wird der Use Case abgebildet, dass der Kunde eine
	 * <b>Bareinzahlung</b> auf einem Konto machen möchte. Es wird hierdurch ein
	 * Buchungssatz
	 * 
	 * <pre>
	 * Kasse <Betrag>
	 ...
	 * 
	 * @param customerAccount
	 *            das Kundenkonto, auf das der Betrag eingezahlt werden soll.
	 * @param amount
	 *            der Betrag, der eingezahlt wird.
	 * @return Ein <code>Transaction</code>-Objekt, das den resultierenden
	 *         Buchungssatz darstellt.
	 */
	@Override
