...
public class BankProjekt implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		/*
		 * Ab hier folgen weitere Button-Definitionen, die nach exakt der
		 * gleichen Methode erfolgen wie beim ersten Button.
		 * 
		 * Da das Muster dazu sich mehrfach wiederholt, könnte man hier schon
		 * von einem unerwünschte Code Clone sprechen. Um dies stilistisch zu
		 * optimieren wäre z.B. die Verwendung des Factory oder Builder Pattern
		 * denkbar. Hierauf wurde jedoch bewusst verzichtet, um den
		 * Komplexitätsgrad dieses Demonstrators nicht unnötig zu erhöhen.
		 */
