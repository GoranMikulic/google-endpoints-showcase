...
public class Bankadministrationapi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "getAccountsOf".
   *
   * This request holds the parameters needed by the bankadministrationapi server.  After setting any
   * optional parameters, call the {@link GetAccountsOf#execute()} method to invoke the remote
   * operation.
   *
   * @param customerId
   * @return the request
   */
  public GetAccountsOf getAccountsOf(java.lang.Integer customerId) throws java.io.IOException {
    GetAccountsOf result = new GetAccountsOf(customerId);
    initialize(result);
    return result;
  }

  public class GetAccountsOf extends BankadministrationapiRequest<com.appspot.skillful_octane_742.bankadministrationapi.model.AccountCollection> {

    private static final String REST_PATH = "accountcollection/{customerId}";

    /**
     * Create a request for the method "getAccountsOf".
     *
     * This request holds the parameters needed by the the bankadministrationapi server.  After
     * setting any optional parameters, call the {@link GetAccountsOf#execute()} method to invoke the
     * remote operation. <p> {@link GetAccountsOf#initialize(com.google.api.client.googleapis.services
     ...
     * @since 1.13
     */
    protected GetAccountsOf(java.lang.Integer customerId) {
      super(Bankadministrationapi.this, "GET", REST_PATH, null, com.appspot.skillful_octane_742.bankadministrationapi.model.AccountCollection.class);
    ...
    @Override
    public GetAccountsOf setAlt(java.lang.String alt) {
      return (GetAccountsOf) super.setAlt(alt);
    }

    @Override
    public GetAccountsOf setFields(java.lang.String fields) {
      return (GetAccountsOf) super.setFields(fields);
    }

    @Override
    public GetAccountsOf setKey(java.lang.String key) {
      return (GetAccountsOf) super.setKey(key);
    }

    @Override
    public GetAccountsOf setOauthToken(java.lang.String oauthToken) {
      return (GetAccountsOf) super.setOauthToken(oauthToken);
    }

    @Override
    public GetAccountsOf setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetAccountsOf) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetAccountsOf setQuotaUser(java.lang.String quotaUser) {
      return (GetAccountsOf) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetAccountsOf setUserIp(java.lang.String userIp) {
      return (GetAccountsOf) super.setUserIp(userIp);
    }
    ...
    public GetAccountsOf setCustomerId(java.lang.Integer customerId) {
      this.customerId = customerId;
      return this;
    }

    @Override
    public GetAccountsOf set(String parameterName, Object value) {
      return (GetAccountsOf) super.set(parameterName, value);
    }
  }
  ...
  /**
   * Create a request for the method "getBalanceOf".
   *
   * This request holds the parameters needed by the bankadministrationapi server.  After setting any
   * optional parameters, call the {@link GetBalanceOf#execute()} method to invoke the remote
   * operation.
   *
   * @param accountId
   * @return the request
   */
  public GetBalanceOf getBalanceOf(java.lang.Integer accountId) throws java.io.IOException {
    GetBalanceOf result = new GetBalanceOf(accountId);
    initialize(result);
    return result;
  }

  public class GetBalanceOf extends BankadministrationapiRequest<com.appspot.skillful_octane_742.bankadministrationapi.model.Balance> {

    private static final String REST_PATH = "balance/{accountId}";

    /**
     * Create a request for the method "getBalanceOf".
     *
     * This request holds the parameters needed by the the bankadministrationapi server.  After
     * setting any optional parameters, call the {@link GetBalanceOf#execute()} method to invoke the
     * remote operation. <p> {@link
     * GetBalanceOf#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param accountId
     * @since 1.13
     */
    protected GetBalanceOf(java.lang.Integer accountId) {
      super(Bankadministrationapi.this, "GET", REST_PATH, null, com.appspot.skillful_octane_742.bankadministrationapi.model.Balance.class);
    ...
    @Override
    public GetBalanceOf setAlt(java.lang.String alt) {
      return (GetBalanceOf) super.setAlt(alt);
    }

    @Override
    public GetBalanceOf setFields(java.lang.String fields) {
      return (GetBalanceOf) super.setFields(fields);
    }

    @Override
    public GetBalanceOf setKey(java.lang.String key) {
      return (GetBalanceOf) super.setKey(key);
    }

    @Override
    public GetBalanceOf setOauthToken(java.lang.String oauthToken) {
      return (GetBalanceOf) super.setOauthToken(oauthToken);
    }

    @Override
    public GetBalanceOf setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetBalanceOf) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetBalanceOf setQuotaUser(java.lang.String quotaUser) {
      return (GetBalanceOf) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetBalanceOf setUserIp(java.lang.String userIp) {
      return (GetBalanceOf) super.setUserIp(userIp);
    }
    ...
    public GetBalanceOf setAccountId(java.lang.Integer accountId) {
      this.accountId = accountId;
      return this;
    }

    @Override
    public GetBalanceOf set(String parameterName, Object value) {
      return (GetBalanceOf) super.set(parameterName, value);
    }
  }
